 ...
 *
 * vivitrx：
 * 00:32:30: The process "C:\Qt\Tools\mingw1120_64\bin\mingw32-make.exe" exited normally.
 * 00:32:30: Elapsed time: 00:00.
 * 另外，recursive call的周期是6次调用，也就是说，每调用6次triggerStackOverflow就会得到一次相同的参数值
 */
